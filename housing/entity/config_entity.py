...
DataValidationConfig = namedtouple("DataValidationConfig",["schema_file_path"])
...
DataTransformationConfig = namedtouple("DataTransformationConfig",["add_bedroom_per_room","transformed_train_dir","transformed_test_dir","preprocessed_object_file_path"])
...
ModelTrainerConfig = namedtouple("ModelTrainerConfig",["trained_model_file_path","base_accuracy"])
...
ModelEvaluationConfig = namedtouple("ModelEvaluationConfig",["model_evaluation_file_path","time_stamp"])
...
# ModelPusherConfigg
ModelPusherConfig = namedtouple("ModelPusherConfig",["export_dir_path"])
